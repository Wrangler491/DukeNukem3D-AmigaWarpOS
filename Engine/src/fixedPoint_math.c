...
{ // Cringe City
	...
	int32_t m[4] = { 0xff00l,0xffl,0xff000000l,0xff0000l };
	int32_t n[4] = { 8,0,24,16 };
	int32_t z=0;
...
{ // ...maybe the same person who provided this too?
    int32_t i; uint16_t *sptr = (uint16_t *)bufptr;
    for(i=0;i<num;i++) { sptr[i] = (uint16_t)(val>>16); val += add; }
}
